var heronames = new Array(
    ...
    new Array("Enchantress","Enigma","Faceless Void","Grimstroke","Gyrocopter","Hoodwink","Huskar","Invoker"),
    new Array("Io", "Jakiro","Juggernaut","Keeper of the Light","Kunkka","Legion Commander","Leshrac","Lich"),
    new Array("Lifestealer","Lina","Lion","Lone Druid","Luna","Lycan","Magnus","Mars"),
    new Array("Medusa","Meepo","Mirana","Monkey King","Morphling","Naga Siren","Nature's Prophet","Necrophos"),
    new Array("Night Stalker","Nyx Assassin","Ogre Magi","Omniknight","Oracle","Outworld Devourer","Pangolier","Phantom Assassin"),
    new Array("Phantom Lancer","Phoenix","Puck","Pudge","Pugna","Queen of Pain","Razor","Riki"),
    new Array("Rubick","Sand King","Shadow Demon","Shadow Fiend","Shadow Shaman","Silencer","Skywrath Mage","Slardar"),
    new Array("Slark","Snapfire","Sniper","Spectre","Spirit Breaker","Storm Spirit","Sven","Techies"),
    new Array("Templar Assassin","Terrorblade","Tidehunter","Timbersaw","Tinker","Tiny","Treant Protector","Troll Warlord"),
    new Array("Tusk","Underlord","Undying","Ursa","Vengeful Spirit","Venomancer","Viper","Visage"),
    new Array("Void Spirit","Warlock","Weaver","Windranger","Winter Wyvern ","Witch Doctor","Wraith King","Zeus")
);
